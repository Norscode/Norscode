# Selfhost Fase 3 - Oppstart

Fase 3 byggjer vidare på den ferdige fase 2-flata og flyttar fokuset frå stabilisering til vidare språk- og kompilatorutviding.

## Målbilete

- [x] Stabil AST-kontrakt for vidare parser- og semantic-arbeid
- [x] Sterkare semantic-kjerne med tydeleg feilrapportering
- [x] IR-til-bytecode-løype som er enklare å følgje og vedlikehalde
- [x] Tydelegare kopling mellom AST, semantic og backend
- [x] ABI og FFI er dokumentert
- [x] Betre backend-optimalisering er dokumentert
- [x] Verktøy og feilsøkingsstøtte er dokumentert
- [x] Breiare standardbibliotek er dokumentert

## Første arbeidsområde

- [x] Kartlegg dei første fase-3-funksjonane i `selfhost/ast.no`
- [x] Samla opp semantiske reglar i `selfhost/semantic.no`
- [x] Dokumenter overgang frå IR til bytecode i `selfhost/compiler/ir_to_bytecode.no`
- [x] Definer minste aksept for fase-3-smoke og regresjonar
...
- [x] ABI-minimum v1
- [x] Runtime-API v1
- [x] Standardbibliotek-løype v1
- [x] CI-status og gate
- [x] DoD og regresjonstestar

## Neste konkrete steg

- [x] Lage fase-3 backlog med prioriterte oppgåver
- [x] Kople opp statusdokument for fase 3
- [x] Velg første funksjonell leveranse i AST eller semantic
- [x] Definere smoke og regresjon
- [x] Definere IR-smoke og IR-regresjon
- [x] Definere ABI og FFI
- [x] Definere verktøy og feilsøkingsstøtte
- [x] Definere breiare standardbibliotek
