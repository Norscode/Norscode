# Historisk flate Dependency Migration Plan

## Goal

Gradually remove historisk vei dependencies from the Norscode compiler chain
...
Do NOT remove historisk vei modules blindly.
...
without historisk vei dependencies.
