...
| JIT-kompilering | ✅ | ✅ | Baseline ARM64/x86-64 for verifiserte heltallsuttrykk; videre VM-integrasjon pågår |  |
...
- Norscode: native forhåndskompilering som hovedløype, med valgfri capability-beskyttet baseline-JIT for varm kode
