...
- `tools/selfhost_maintenance_verify.no` skal gå grønt når driftsdocs, arkiv og deprecations peker samme vei.
- `./bin/nc run tools/selfhost_drift_guard.no` skal gå grønt som samlet gate for fase 0 og vedlikeholdsregler.
