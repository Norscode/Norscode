...
Den aktive appvarianten i workflowen er no GUI-host-sporet, ikkje den eldre Terminal-launcheren. Dersom Terminal-varianten trengst for vedlikehald eller samanlikning, kan han framleis byggjast lokalt med `bash tools/build-macos-app.sh --mode terminal`.
