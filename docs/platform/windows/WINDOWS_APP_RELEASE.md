...
- [tools/package-windows-app.sh](../tools/package-windows-app.sh)

Bruk:

```bash
bash tools/package-windows-app.sh path/to/norscode.exe
```
...
2. kople `tools/package-windows-app.sh` til den
