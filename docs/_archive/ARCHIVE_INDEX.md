...
Bruk denne siden når du trenger historikk, migreringsspor eller utfasing som ikke lenger er en del av normal bruk.
...
- [docs/HISTORISK_UTFASING.md](HISTORISK_UTFASING.md)
- [docs/FULL_INDEPENDENCE_STATUS.md](FULL_INDEPENDENCE_STATUS.md)

## Aktiv normalreferanse

Hvis du egentlig leter etter dagens dokumentasjon, start her:
