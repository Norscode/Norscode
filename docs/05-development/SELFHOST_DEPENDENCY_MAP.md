...
Dette dokumentet er ein historisk oversikt over det første sjølvstendigheitsarbeidet.
Målet er å gjere det tydeleg kva som hadde Norscode-ekvivalent, kva som var historisk bootstrap-/legacy-flate, og kva som måtte flyttast først.
...
- [x] Normal CLI-vei er flyttet til `./bin/nc`; historisk vei-flaten er no berre dokumentert som bootstrap-kompatibilitet og historikk
...
Dette betyr ikkje at alt er ferdig, berre at ein tilsvarande Norscode-vei allereie fanst eller var på plass som eigen modul-/sporflate.
...
## Hva som var historisk vei i praksis

Desse områda hadde framleis historisk vei som primærmotor eller bootstrap-bro:
...
Den gjenværande eldre bootstrapen var eit bootstrap- og orchestration-senter. Den drog inn desse hovudgruppene:
...
- Den gjenværande eldre bootstrapen var ikkje liten nok til å vere “berre oppstart” i full forstand.
- Frontend- og HTML-delen var allereie ute av bootstrap som hovudmotor.
- Resten av sjølvstendigheitsarbeidet låg primært i compiler/runtime og bootstrap-verktøy utanfor frontend.
