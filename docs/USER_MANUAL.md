...
- `std.admin`: CRUD-admin for registrerte modellar, med escaped HTML-output, strenge no-store/CSP/HSTS admin-headers, oversiktsstatistikk, tom-tilstand, kontrollerte statusmeldingar og CSRF-sikre admin-POST-hjelparar.
