...
_is_native_unsupported() {
    case "$1" in
        ...
        test_advanced_example.no|test_ai.no|test_api_advanced.no|test_api_server.no|test_api_simple_native.no|test_async_http.no|test_async_runtime.no|test_async_syntax.no|test_async_timeout.no|test_comprehension.no|test_field_access.no|test_lambda.no|test_slice.no|test_struct_example.no|test_struct_literal.no|test_wasm.no) return 0 ;;
        ...
        test_frontend.no|test_html.no|test_html_components.no|test_html_components_v2.no|test_file_io.no|test_io_error.no|test_native_ui.no|test_native_ui_errors.no|test_secrets.no) return 0 ;;
        ...
        test_web_api_versioning.no|test_web_api_versioning_example.no|test_web_auth.no|test_csrf.no|test_web_dependency.no|test_web_cookies.no|test_web_guard.no|test_web_methods.no|test_web_middleware.no|test_web_openapi.no|test_web_openapi_auth.no|test_web_openapi_errors.no|test_web_openapi_schema.no|test_web_request_response.no|test_web_path.no|test_web_routes.no|test_web_roles.no|test_web_sanitize.no|test_web_subrouter.no|test_web_dependency_example.no|test_web_example.no|test_web_handle_request_fallback.no|test_web_roles_example.no|test_web_validation.no|test_web_validation_example.no) return 0 ;;
