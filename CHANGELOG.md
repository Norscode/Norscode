...
#### Bygging frå kjelde
```bash
./bin/nc bygg-native                    # Bygg native runtime
./bin/nc local-green                    # Køyr lokal release-preflight, aktiv flate, fase-0, L1-L6 og full testport
./bin/nc bootstrap-self                 # Verifiser selfhosting steg C
```
